...
class LoggerConfig:
    @staticmethod
    def setup_logger(script_name: str, log_file_dir: str = "./data/log/", log_level: str = "INFO", log_file_prefix: str = "video_") -> None:
        """
        ...
        """
        log_file_name = f"{log_file_prefix}{script_name}.log"
        ...
        if os.path.exists(log_file_path):
            ...
            new_log_file_path = os.path.join(log_file_dir, f"{log_file_prefix}{script_name}_{timestamp}.log")
            try:
